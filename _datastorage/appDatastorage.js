...
| ---- | ---- |
| 0.01 ${sym[n]} | {{ 0.01 | ${sol}: page.value }} ${sym[i]} |
| 0.1 ${sym[n]} | {{ 0.1 | ${sol}: page.value }} ${sym[i]} |
| 0.25 ${sym[n]} | {{ 0.25 | ${sol}: page.value }} ${sym[i]} |
| 0.5 ${sym[n]} | {{ 0.50 | ${sol}: page.value }} ${sym[i]} |
| 1 ${sym[n]} | {{ 1.0 | ${sol}: page.value }} ${sym[i]} |
| 2 ${sym[n]} | {{ 2.0 | ${sol}: page.value }} ${sym[i]} |
| 3 ${sym[n]} | {{ 3.0 | ${sol}: page.value }} ${sym[i]} |
| 5 ${sym[n]} | {{ 5.0 | ${sol}: page.value }} ${sym[i]} |
| 10 ${sym[n]} | {{ 10.0 | ${sol}: page.value }} ${sym[i]} |
| 100 ${sym[n]} | {{ 100.0 | ${sol}: page.value }} ${sym[i]} |

## ${name[i]} to ${name[n]} Convertion Table :

| ${name[i]} (${sym[i]}) | ${name[n]} (${sym[n]}) |
| ---- | ---- |
| 0.01 ${sym[i]} | {{ 0.01 | ${sol2}: page.value }} ${sym[n]} |
| 0.1 ${sym[i]} | {{ 0.1 | ${sol2}: page.value }} ${sym[n]} |
| 0.25 ${sym[i]} | {{ 0.25 | ${sol2}: page.value }} ${sym[n]} |
| 0.5 ${sym[i]} | {{ 0.50 | ${sol2}: page.value }} ${sym[n]} |
| 1 ${sym[i]} | {{ 1.0 | ${sol2}: page.value }} ${sym[n]} |
| 2 ${sym[i]} | {{ 2.0 | ${sol2}: page.value }} ${sym[n]} |
| 3 ${sym[i]} | {{ 3.0 | ${sol2}: page.value }} ${sym[n]} |
| 5 ${sym[i]} | {{ 5.0 | ${sol2}: page.value }} ${sym[n]} |
| 10 ${sym[i]} | {{ 10.0 | ${sol2}: page.value }} ${sym[n]} |
| 100 ${sym[i]} | {{ 100.0 | ${sol2}: page.value }} ${sym[n]} |
